...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/fiction/zfiction6.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>Marked</h1>
                <h4>published by:PC Cast and Kristin Cast</h4>
		
               
                    <h3><i>After a Vampire Tracker Marks her with a crescent moon on her forehead, 16-year-old Zoey Redbird enters the House of Night and learns that she is no average fledgling. She has been Marked as special by the vampyre Goddess Nyx and has affinities for all five elements: Air, Fire Water, Earth and Spirit.
</i></h3>
                    <div><a href="zfiction6.PDF" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
