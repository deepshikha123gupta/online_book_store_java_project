...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/fiction/zfiction4.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>Evernight</h1>
                <h4>published by:Claudia Gray</h4>
		
               
                    <h3><i>She's been uprooted from her small hometown and enrolled at Evernight Academy, an eerie Gothic boarding school where the students are somehow too perfect: smart, sleek, and almost predatory. Bianca knows she doesn't fit in. Then she meets Lucas. He's not the "Evernight type" either, and he likes it that way
</i></h3>
                    <div><a href="zfiction4.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
