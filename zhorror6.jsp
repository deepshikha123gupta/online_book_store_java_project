...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/horror/zhorror6.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>A Thin Ghost And Others</h1>
                <h4>published by:James,Montague Rhodes</h4>
		
               
                    <h3><i>A Thin Ghost and Others is M. R. James' third collection of ghost stories, published in 1919.</i></h3>
                    <div><a href="zhorror6.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
