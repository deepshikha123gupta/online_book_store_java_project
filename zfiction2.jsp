...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/fiction/zfiction2.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
		...
		<h1>City Of Bones</h1>
                <h4>published by:Cassandra Clare</h4>
                    ...
                    <h3><i>When fifteen-year-old Clary Fray heads out to the Pandemonium Club in New York City, she hardly expects to witness a murder? much less a murder committed by three teenagers covered with strange tattoos and brandishing bizarre weapons. Then the body disappears into thin air.
</i></h3>
                    <div><a href="zfiction2.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
