...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/kids/zkids7.jpg" alt="Northern Lights" width="400" height="400"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>The Mixed Up Pet Shop</h1>
                <h4>published by:Michelle Dennise</h4>
		
               
                    <h3><i>Michelle Dennise and his 5 year old daughter Pell have put together a book of seven illustrated poems. For every painting done by Pell, Kanika has written a quirky and adorable poem.</i></h3>
                    <div><a href="zkids7.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
