...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/fiction/zfiction5.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>Glass House</h1>
                <h4>published by:Brian Alexander</h4>
		
               
                    <h3><i> From the author of the popular Weather Warden series comes the debut of an exciting new series set in Morganville, Texas, where you would be well advised to avoid being out after dark.

College freshman Claire Danvers has had enough of her nightmarish dorm situation. When Claire heads off-campus, the imposing old house where she finds a room may not be much better.
</i></h3>
                    <div><a href="zfiction5.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
