...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/kids/zkids5.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>How The Children Became Stars</h1>
                <h4>published by:Aaron Zerah</h4>
		
               
                    <h3><i>How the Children Became Stars is a collection of 52 fables and folk tales from all over the world. The folk tales help foster an understanding of other cultures, along with providing important morals and life lessons. Each folk tale has an activity at the end, which makes it perfect for classroom or home-school use, and with 52 tales to choose from, it can easily integrate it into a weekly curriculum.
