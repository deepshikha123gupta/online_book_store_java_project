...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/fiction/zfiction3.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>Clockwork Angle</h1>
                <h4>published by:Cassandra Clare</h4>
		
               
                    <h3><i> In a time when Shadowhunters are barely winning the fight against the forces of darkness, one battle will change the course of history forever. Welcome to the Infernal Devices trilogy, a stunning and dangerous prequel to the New York Times bestselling Mortal Instruments series.
</i></h3>
                    <div><a href="zfiction3.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
