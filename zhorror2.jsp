...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/horror/zhorror2.jpg" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>The Shunned House</h1>
                <h4>published by:H.P.Lovecraft</h4>
		
               
                    <h3><i>"The Shunned House" is a horror fiction novelette by American author H. P. Lovecraft, written on October 16?19, 1924. It was first published in the October 1937 issue of Weird Tales.The Shunned House of the title is based on an actual house in Providence, Rhode Island built around 1763 and still standing at 135 Benefit Street. Lovecraft was familiar with the house because his aunt Lillian Clark lived there in 1919-20 as a companion to Mrs. H. C. Babbit.[1]

But it was another house in Elizabeth, New Jersey that actually provoked Lovecraft to write the story. As he wrote in a letter:</i></h3>
                    <div><a href="zhorror2.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
