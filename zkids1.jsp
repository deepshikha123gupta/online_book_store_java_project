...
<!-- Collect the nav links, forms, and other content for toggling -->
       <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<div class="col-md-5">
		<h4><img src="photos/kids/zkids1.png" alt="Northern Lights" width="500" height="500"></h4>
		</div>
                    
                <div class="col-md-6">
		<h1>Wildlife In A City Pond</h1>
                <h4>published by:Ashish Kothari</h4>
		
               
                    <h3><i>Wildlife in a City Pond is a a level 4 picture from Pratham?s storyweaver platform.
...
Author: Ashish Kothari
                    ...
                    <div><a href="zkids1.pdf" class="btn btn-success">READ BOOK</a></div>
                </div>
                     <br><br>
		</div>
